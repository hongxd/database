...
public class NoticeConfig : IEntityTypeConfiguration<Notice>
{
    public void Configure(EntityTypeBuilder<Notice> builder)
    {
        ...
        builder.Property(notice => notice.Content).HasColumnName("content").HasMaxLength(500).HasComment("发布内容").IsRequired();
        builder.Property(notice => notice.Title).HasColumnName("title").HasMaxLength(50).HasComment("公告标题").IsRequired();
    }
}