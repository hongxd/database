...
namespace database.Entities
{
    public class DormmanagerConfig: IEntityTypeConfiguration<Dormmanager>
    {
        public void Configure(EntityTypeBuilder<Dormmanager> builder)
        {
            ...
            builder.Property(dormmanager => dormmanager.Password).HasColumnName("password").HasMaxLength(20).HasComment("密码");
            builder.Property(dormmanager => dormmanager.DormBuildId).HasColumnName("dormBuildId").HasComment("宿舍楼Id");
            builder.Property(dormmanager => dormmanager.DormBuildDetail).HasColumnName("dormBuildDetail").HasMaxLength(50).HasComment("宿舍楼详细说明");
            builder.Property(dormmanager => dormmanager.Name).HasColumnName("name").HasMaxLength(10).HasComment("真实姓名");
            builder.Property(dormmanager => dormmanager.Sex).HasColumnName("sex").HasComment("性别");
            builder.Property(dormmanager => dormmanager.Tel).HasColumnName("tel").HasComment("电话").HasMaxLength(11).IsFixedLength();
        }
    }
}
